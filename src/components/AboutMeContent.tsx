    ...
    <section className="text-neutral-50 flex flex-col gap-5 md:gap-20 md:w-8/12">
      <div className="flex flex-col gap-8">
        ...
        <p className="text-md font-thin text-justify tracking-wider">
          A passionate and results-driven JavaScript developer with a proven
          ...
          e-commerce platforms to optimizing performance using React and
          JavaScript.{" "}
        </p>
        <p className="font-thin text-justify tracking-wider">
          ...
          effective communication, I&apos;ve honed my skills in full-stack
